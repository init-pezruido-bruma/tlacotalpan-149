...
export const unitHotspots: Record<string, UnitHotspot[]> = {
  ...
  "townhouse-202": [
    { label: "Recámara principal", spaceId: "recamara-01", floor: 0, x: 63, y: 64 },
    { label: "Baño principal", spaceId: "bano", floor: 0, x: 52, y: 52 },
    { label: "Recámara 02", spaceId: "recamara-02", floor: 0, x: 34, y: 32 },
    { label: "Baño 02", spaceId: "bano-02", floor: 0, x: 44, y: 40 },
    { label: "Sala TV", spaceId: "sala-tv", floor: 0, x: 46, y: 44 },
    { label: "Sala comedor", spaceId: "sala-comedor", floor: 1, x: 55, y: 58 },
    { label: "Cocina", spaceId: "cocina", floor: 1, x: 45, y: 48 },
    { label: "Roof garden", spaceId: "roof-garden", floor: 2, x: 40, y: 43 },
  ],
};
